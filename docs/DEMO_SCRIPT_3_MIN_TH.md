...
อัปเดต 17 กันยายน 2026: ใช้ `Offline / Rules` เป็นเส้นทางหลักที่ผ่าน full gold-set evaluation ส่วน Gemini/OpenRouter เป็น experimental modes และไม่ใช้คะแนน 97.30% อ้างเป็นคะแนน LLM
